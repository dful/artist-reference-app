...
export const HARMONY_DESCRIPTIONS = {
  complementary: 'Colors opposite on the wheel create high contrast and vibrant look',
  analogous: 'Colors next to each other create serene, comfortable designs',
  triadic: 'Three colors equally spaced offer vibrant contrast while retaining balance',
  splitComplementary: 'Base color plus two colors adjacent to its complement',
  tetradic: 'Four colors forming a rectangle, works best with one dominant color',
...
export const BONE_DEFINITIONS = {
  // Root
  hips: { label: 'Hips', mixamoName: 'mixamorigHips', limits: { x: [-30, 30], y: [-45, 45], z: [-30, 30] } },
  // Spine chain
  spine: { label: 'Lower Spine', mixamoName: 'mixamorigSpine', limits: { x: [-30, 30], y: [-30, 30], z: [-20, 20] } },
  spine1: { label: 'Middle Spine', mixamoName: 'mixamorigSpine1', limits: { x: [-30, 30], y: [-30, 30], z: [-20, 20] } },
  spine2: { label: 'Upper Spine', mixamoName: 'mixamorigSpine2', limits: { x: [-30, 30], y: [-30, 30], z: [-20, 20] } },
  neck: { label: 'Neck', mixamoName: 'mixamorigNeck', limits: { x: [-40, 40], y: [-60, 60], z: [-30, 30] } },
  head: { label: 'Head', mixamoName: 'mixamorigHead', limits: { x: [-40, 40], y: [-70, 70], z: [-30, 30] } },
  // Left arm chain
  leftShoulder: { label: 'Left Shoulder', mixamoName: 'mixamorigLeftShoulder', limits: { x: [-20, 20], y: [-30, 30], z: [-20, 20] } },
  leftArm: { label: 'Left Upper Arm', mixamoName: 'mixamorigLeftArm', limits: { x: [-180, 90], y: [-90, 90], z: [-90, 60] } },
  leftForeArm: { label: 'Left Forearm', mixamoName: 'mixamorigLeftForeArm', limits: { x: [-150, 0], y: [-20, 20], z: [-20, 20] } },
  leftHand: { label: 'Left Hand', mixamoName: 'mixamorigLeftHand', limits: { x: [-60, 60], y: [-40, 40], z: [-60, 60] } },
  // Right arm chain
  rightShoulder: { label: 'Right Shoulder', mixamoName: 'mixamorigRightShoulder', limits: { x: [-20, 20], y: [-30, 30], z: [-20, 20] } },
  rightArm: { label: 'Right Upper Arm', mixamoName: 'mixamorigRightArm', limits: { x: [-180, 90], y: [-90, 90], z: [-60, 90] } },
  rightForeArm: { label: 'Right Forearm', mixamoName: 'mixamorigRightForeArm', limits: { x: [0, 150], y: [-20, 20], z: [-20, 20] } },
  rightHand: { label: 'Right Hand', mixamoName: 'mixamorigRightHand', limits: { x: [-60, 60], y: [-40, 40], z: [-60, 60] } },
  // Left leg chain
  leftUpLeg: { label: 'Left Thigh', mixamoName: 'mixamorigLeftUpLeg', limits: { x: [-120, 60], y: [-60, 60], z: [-60, 60] } },
  leftLeg: { label: 'Left Shin', mixamoName: 'mixamorigLeftLeg', limits: { x: [0, 150], y: [0, 0], z: [0, 0] } },
  leftFoot: { label: 'Left Foot', mixamoName: 'mixamorigLeftFoot', limits: { x: [-50, 50], y: [-30, 30], z: [-40, 40] } },
  // Right leg chain
  rightUpLeg: { label: 'Right Thigh', mixamoName: 'mixamorigRightUpLeg', limits: { x: [-120, 60], y: [-60, 60], z: [-60, 60] } },
  rightLeg: { label: 'Right Shin', mixamoName: 'mixamorigRightLeg', limits: { x: [0, 150], y: [0, 0], z: [0, 0] } },
  rightFoot: { label: 'Right Foot', mixamoName: 'mixamorigRightFoot', limits: { x: [-50, 50], y: [-30, 30], z: [-40, 40] } },
};
