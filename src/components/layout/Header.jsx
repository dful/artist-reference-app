...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800 pt-[env(safe-area-inset-top)]">
