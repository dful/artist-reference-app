  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <button
        ...
        className="px-3 py-2 text-sm bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400 transition-colors ml-auto flex items-center gap-1"
...
export const PoseCreatorPage = () => {
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col lg:flex-row gap-6">
      ...
      {/* Controls Panel */}
      <div className="w-full lg:w-80 flex-shrink-0 space-y-6 overflow-y-auto max-h-[calc(100vh-8rem)]">
