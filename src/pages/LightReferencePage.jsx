  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <button
        ...
        className="px-3 py-2 text-sm bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400 transition-colors ml-auto"
      >
        Reset All
      </button>
    </div>
